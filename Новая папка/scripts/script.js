...
const cardsImages = document.querySelector(".cta-image-wrapper");
if (cardsImages) {
    const cardListImages = cardsImages.querySelector(".cta-images");
    ...
    // Загрузка данных с сервера
            fetch(apiUrl)
                ...
                .then((images) => {
                 ...
                 const pictures = document.querySelectorAll(".cta-images");
if (pictures) {
    ...
    pictures.forEach((picture) => {
        picture.addEventListener("click", () => {
            ...
            const parentPictures =
                parentItem.querySelectorAll(".cta-images");
